...
namespace Campeonato.Controllers
{
    public class TorneiosController : Controller
    {
        ...
        {
            ViewData["IdModalidade"] = new SelectList(_context.TipoModalidades, "IdModalidade", "IdModalidade");
            ViewData["IdTipoTorneio"] = new SelectList(_context.TipoTorneios, "IdTipoTorneio", "IdTipoTorneio");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTorneio,NomeTorneio,DataInicio,DataFim,IdModalidade,IdTipoTorneio")] Torneio torneio)
        {
            ...
            ViewData["IdModalidade"] = new SelectList(_context.TipoModalidades, "IdModalidade", "IdModalidade", torneio.IdModalidade);
            ViewData["IdTipoTorneio"] = new SelectList(_context.TipoTorneios, "IdTipoTorneio", "IdTipoTorneio", torneio.IdTipoTorneio);
            return View(torneio);
        }
